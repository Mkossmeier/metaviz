...
More details and further references can be found in the respective help files.
```{r, message=FALSE}
# help(mozart)
# help(rainforest)
```
...
The function `rainforest` uses the package [**ggplot2**](https://cran.r-project.org/web/packages/ggplot2/index.html) to create the plots. Therefore, the output of `rainforest` is a [**ggplot2**](https://cran.r-project.org/web/packages/ggplot2/index.html) object and can be modified using the [**ggplot2**](https://cran.r-project.org/web/packages/ggplot2/index.html) syntax. We illustrate this with three examples below.
