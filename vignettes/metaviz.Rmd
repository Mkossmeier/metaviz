...
For forest plots and thick forest plots it is possible to individually custimize the color of studies by suppplying a vector of colors to the `col` argument. The color of the summary effect(s) can be customized individually as well with the `summary_col` argument.
