...
create forest plots, funnel plots, and many of their variants (e.g., rainforest plots; addtional evidence 
contour enhanced funnel plots). In addition, functionalities for visual funnel plot inference are 
provided. In the near future, the metaviz package will be extended by further,
...
- March 12, 2018: Version 0.2 submtited to CRAN
